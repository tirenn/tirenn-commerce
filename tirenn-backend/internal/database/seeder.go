...
func Seed(db *gorm.DB) error {
	...
	db.Exec("TRUNCATE TABLE order_items, orders, stock_adjustment_logs, products, sub_categories, categories, users RESTART IDENTITY CASCADE;")
